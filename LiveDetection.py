'''
Created by Daniel-Iosif Trubacs for the UoS AI society on 2 January 2022. To be used with the SRModel and t
he HandDectection packages. Using a trained Convolutional Neural net (trained on the SIGN_MNIST DATA) and a Hand Detection Algorithm
