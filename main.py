...
This Collab has been created by Daniel-Iosif Trubacs for the UOS AI SOCIETY on 2 January 2022
...
For easier reading, the code is split in parts. Each part is commented at the beggining and is separated by the other parts by 3 empty lines.
'''
...
'''
# buidling the basics of the model
def build_model(Input_Shape):
    ...
    # using softmax for returning a probability distrubution
...
plt.title("Sign Languare Recognition model")
plt.subplot(211)
